    ...
    <div class="wrapper">
      <div class="d-xl-flex h-100 w-100 justify-content-center align-items-center">
        <div class="d-block d-md-none">
          <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/08/hero-set-06-2020-xs.jpg" class="w-100">
        </div>
        <div class="d-none d-md-block position-relative w-100">
          <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2020/08/hero-set-06-2020-md.jpg" class="w-100">
